...
def train_model(pretrained_model_path):
    ...
    model = model_training.load_from_checkpoint("/Time_Classifiction/Classification/sh_ducoment/epoch=950-step=1216329.ckpt")
...
if __name__ == '__main__':
    ...
    a = ''
    model, acc_results, f1_results = train_model(a)
